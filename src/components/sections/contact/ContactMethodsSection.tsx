...
export function ContactMethodsSection({ contactMethods }: ContactMethodsSectionProps) {
  return (
    <section className="py-20 sm:py-24 xl:py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-background via-emerald-500/3 to-background relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5 lg:gap-6 mb-12 sm:mb-16 xl:mb-20">
