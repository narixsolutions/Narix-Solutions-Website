    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="pt-16 pb-6 px-4 sm:px-6 lg:px-8 border-b border-border/60 bg-card/30">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Hero images + intro */}
          <FadeInView className="mt-10 grid gap-6 lg:grid-cols-2 lg:items-start">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto space-y-12">
          {/* Security card */}
          <FadeInView className="rounded-2xl border border-border bg-card p-6 md:p-8 flex gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-foreground mb-3">Security &amp; vulnerability posture</h2>
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 border-t border-border bg-card/40">
        <FadeInView className="max-w-3xl mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 text-center sm:text-left">
          <div>
