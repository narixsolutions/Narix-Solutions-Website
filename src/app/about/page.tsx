    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="pt-16 sm:pt-20 lg:pt-24 pb-8 sm:pb-12 px-4 sm:px-6 lg:px-8">
        <FadeInView className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-bold text-foreground mb-6 text-balance">
            ...
            <span className="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">scale</span>
          </h1>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-secondary/50">
        <div className="max-w-7xl mx-auto">
          <AnimateStagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 xl:gap-8">
            {stats.map((stat) => {
              const IconComponent = stat.icon;
              return (
                <AnimateItem key={stat.label}>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-secondary/50">
        <div className="max-w-6xl mx-auto">
          <FadeInView className="text-center mb-10 sm:mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground">Core Values</h2>
          </FadeInView>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-secondary/50">
        <div className="max-w-6xl mx-auto">
          <FadeInView className="text-center mb-10 sm:mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground">Why businesses work with us</h2>
          </FadeInView>
