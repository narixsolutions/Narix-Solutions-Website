            ...
            <button
              ...
              className={`px-4 py-2.5 rounded-full text-sm font-medium transition-all duration-300 ${
                selectedCategory === category
                  ? 'bg-gradient-to-r from-accent to-blue-500 text-white shadow-lg shadow-accent/30'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project) => (
            ...
            >
              ...
              <div className="w-full h-48 bg-gradient-to-br from-accent/30 via-blue-500/20 to-purple-500/10 flex items-center justify-center relative overflow-hidden group-hover:scale-105 transition-transform duration-500">
                ...
                <div className="grid grid-cols-2 gap-3 mb-4 py-4 border-t border-border/50">
                  {project.stats.slice(0, 2).map((stat, idx) => (
                    <div key={idx} className="text-center">
                      <div className="text-sm font-bold bg-gradient-to-r from-accent to-blue-500 bg-clip-text text-transparent">{stat.value}</div>
