        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <div key={idx} className="bg-card border border-border rounded-xl p-8 hover:border-emerald-500/50 transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="relative">
                ...
                {idx < 3 && <div className="hidden lg:block absolute top-1/2 -right-3 w-6 h-0.5 bg-gradient-to-r from-emerald-500 to-transparent"></div>}
              </div>
            ))}
          </div>
        </div>
